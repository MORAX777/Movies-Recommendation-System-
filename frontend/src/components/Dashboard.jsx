        ...
        {!search && !genreName && history.length > 0 && (
          <div className="mb-6 animate-fadeIn">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
              {history.map(m => (
                <Link to={`/movie/${m.MovieID}`} key={m.MovieID} className="min-w-[120px] group relative flex-shrink-0">
        ...
        {!search && !genreName && personalRecs.length > 0 && (
          <div className="mb-8">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              {personalRecs.map(m => (
                <Link to={`/movie/${m.MovieID}`} key={m.MovieID} className="min-w-[90px] group flex-shrink-0 hover:-translate-y-1 transition duration-300">
